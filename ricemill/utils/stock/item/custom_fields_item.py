...
def property_setter_item_field():
    make_property_setter("Item", "inspection_criteria", "label","Quality Inspection Criteria",""),
    make_property_setter("Item", "quality_inspection_template", "depends_on","inspection_required_before_purchase","")
